...
# extrae y despues elimina las fichas del grupo especificado usadas o sin usar en general
mysql -uroot -e "use radius; SELECT username FROM radusergroup WHERE groupname = '3HrPausada'" |sort > /tmp/expired.users.txt
num=0
